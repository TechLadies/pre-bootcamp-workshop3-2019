...
![static/images/ss-0-1.svg](static/images/ss-0-1.svg)
...
<a href="https://pokeapi.co/api/v2/pokemon/ditto" style={{ justifyContent: 'center', display: 'flex' }}>
...
![https://github.com/PokeAPI/sprites/raw/master/sprites/pokemon/16.png](https://github.com/pokeapi/sprites/raw/master/sprites/pokemon/16.png)
...
<h3 class="primary">React.memo(Component);</h3>

prevent re-render if each props is not change
...
<h3 class="primary">useCallback(callback, [dependency]);</h3>

return same reference if dependency is not changed
...
[![ss-5-1.png](static/images/ss-5-1.png)](https://sass-lang.com/)
...
[![nes.css](https://ph-files.imgix.net/17c995d7-53d0-4545-bfad-cd688d1ba809?auto=format&auto=compress&codec=mozjpeg&cs=strip&w=80&h=80&fit=crop&dpr=2)](https://nostalgic-css.github.io/NES.css/)
